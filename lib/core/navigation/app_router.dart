...
// Importar outras telas aqui quando forem criadas, ex: HomeScreen
...
class AppRouter {
  static final GoRouter router = GoRouter(
    ...
    routes: <RouteBase>[
      ...
      // Exemplo de rota para uma tela principal após login (a ser criada)
      // GoRoute(
      //   path: '/home',
      //   name: 'home',
      //   builder: (BuildContext context, GoRouterState state) {
      //     return const HomeScreen(); // Será criada
      //   },
      // ),
