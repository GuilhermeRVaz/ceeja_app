...
**Para Declarações de Escolaridade:**
  ...
  - **Última Série Concluída:** Identifique a última série ou ano concluído pelo aluno, **NO FORMATO EXATO 'Xª Série Ensino Fundamental' ou 'Xª Série do Ensino Médio' (sem 'do' para fundamental, com 'do' para médio)**. Ex: "5ª Série Ensino Fundamental", "3ª Série do Ensino Médio".
